...
auth.post("/signup", async (req, res) => {
  try {
    ...
    // Send welcome email (await — NOT callback)
    await transporter.sendMail({
      from: "admin@Priyadarshi.youtube.app",
      to: email,
      subject: "Welcome to Priyadrshi's YouTube Clone!",
      html: `
        <h2>Welcome ${name} 👋</h2>
...
auth.post("/resetlink", async (req, res) => {
  try {
    ...
    const mailOptions = {
      from: "admin@Priyadrshi.youtube.app",
      to: email,
      ...
      html: `
        <div style="font-family: Arial, sans-serif; background-color: #f5f5f5; padding: 20px;">
          ...
          <p style="color: #888;">Best regards,<br/>Priyadrshi</p>
        </div>
      `,
    };
