...
function OtherChannel() {
  ...
  useEffect(() => {
    const getUserMail = async () => {
      try {
        const response = await fetch(`${backendURL}/channel/getotherchannel/${id}`);
  ...
  useEffect(() => {
    const getChannelData = async () => {
      try {
        if (Email) {
          const response = await fetch(`${backendURL}/channel/getchannel/${Email}`);
  ...
  useEffect(() => {
    const getChannelCover = async () => {
      try {
        if (Email) {
          const response = await fetch(`${backendURL}/channel/getcover/${Email}`);
  ...
  useEffect(() => {
    const getSubscribers = async () => {
      try {
        if (Email) {
          const response = await fetch(`${backendURL}/channel/getchannelid/${Email}`);
  ...
  useEffect(() => {
    const getUserVideos = async () => {
      try {
        if (Email) {
          const response = await fetch(`${backendURL}/videos/getuservideos/${Email}`);
      ...
      try {
        if (user?.email) {
          const response = await fetch(
            `${backendURL}/channel/checksubscription/${id}/${user?.email}`
          );
  ...
  const SubscribeChannel = async () => {
    try {
      ...
      const response = await fetch(
        `${backendURL}/channel/subscribe/${id}/${user?.email}/${Email}`,
        {
          method: "POST",
          credentials: "include",
