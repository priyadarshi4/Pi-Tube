...
function Playlists() {
      ...
      try {
        if (id) {
          const response = await fetch(
            `${backendURL}/videos/getplaylists/${id}`
          );
    ...
    const getChannelID = async () => {
      try {
        if (playlistDetails.owner_email !== undefined) {
          const response = await fetch(
            `${backendURL}/channel/getchannelid/${playlistDetails.owner_email}`
          );
  ...
  useEffect(() => {
    const GetSavedPlaylistData = async () => {
      try {
        if (id) {
          const response = await fetch(
            `${backendURL}/videos/getsavedplaylist/${id}/${user?.email}`
          );
  ...
  const saveEditData = async () => {
    try {
      const response = await fetch(`${backendURL}/videos/saveplaylist/${id}`, {
        method: "POST",
  ...
  const DeletePlaylist = async () => {
    try {
      const response = await fetch(
        `${backendURL}/videos/deleteplaylist/${id}`,
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
  ...
  const setPrivacy = async (privacy) => {
    try {
      const response = await fetch(`${backendURL}/videos/saveplaylistprivacy/${id}`, {
        method: "POST",
  ...
  const SaveOtherPlaylist = async () => {
    try {
      const response = await fetch(
        `${backendURL}/videos/addotherplaylist/${id}/${user?.email}`,
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
