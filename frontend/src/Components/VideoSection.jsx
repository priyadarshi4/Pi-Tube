...
function VideoSection() {
      ...
      try {
        if (user?.email) {
          const response = await fetch(
            `${backendURL}/channel/checkchannel/${user?.email}`
          );
  ...
  useEffect(() => {
    const getChannel = async () => {
      try {
        if (user?.email) {
          const response = await fetch(
            `${backendURL}/channel/getchannel/${user?.email}`
          );
  ...
  useEffect(() => {
    const getTrendingData = async () => {
      try {
        if (id) {
          const response = await fetch(`${backendURL}/videos/gettrendingdata/${id}`);
  ...
  useEffect(() => {
    const PushTrending = async () => {
      try {
        if (id && usermail) {
          const response = await fetch(
            `${backendURL}/videos/checktrending/${id}/${usermail}`
          );
          await response.json();
        }
      } catch (error) {
  ...
  useEffect(() => {
    const getVideoData = async () => {
      try {
        if (id) {
          const response = await fetch(`${backendURL}/videos/videodata/${id}`);
  ...
  useEffect(() => {
    const getVideos = async () => {
      try {
        const response = await fetch(`${backendURL}/videos/getvideos`);
        const {
          thumbnailURLs,
          titles,
          Uploader,
  ...
  useEffect(() => {
    const getLikes = async () => {
      try {
        if (id) {
          const response = await fetch(`${backendURL}/likes/getlike/${id}`);
  ...
  useEffect(() => {
    const LikeExists = async () => {
      try {
        if (id && user?.email) {
          const response = await fetch(
            `${backendURL}/likes/getuserlikes/${id}/${user?.email}`
          );
  ...
  useEffect(() => {
    const CommentLikes = async () => {
      try {
        if (id) {
          const response = await fetch(`${backendURL}/comments/likecomment/${id}`);
  ...
  useEffect(() => {
    const getWatchlater = async () => {
      try {
        if (id && user?.email) {
          const response = await fetch(
            `${backendURL}/videos/checkwatchlater/${id}/${user?.email}`
          );
          const data = await response.json();
          if (data === "Found") {
            setIsSaved(true);
  ...
  useEffect(() => {
    const getComments = async () => {
      try {
        if (id) {
          const response = await fetch(`${backendURL}/comments/getcomments/${id}`);
          const result = await response.json();
          setComments(result);
        }
      } catch (error) {
  ...
  useEffect(() => {
    const getOtherChannel = async () => {
      try {
        if (id) {
          const response = await fetch(`${backendURL}/channel/otherchannel/${id}`);
  ...
  useEffect(() => {
    const getChannelID = async () => {
      try {
        if (usermail) {
          const response = await fetch(
            `${backendURL}/channel/getchannelid/${usermail}`
          );
  ...
  useEffect(() => {
    const GetChannelData = async () => {
      try {
        if (usermail) {
          const response = await fetch(`${backendURL}/channel/subscribe/${usermail}`);
    ...
    const checkSubscription = async () => {
      try {
        if (user?.email && channelID !== undefined) {
          const response = await fetch(
            `${backendURL}/channel/checksubscription/${channelID}/${user?.email}`
          );
  ...
  useEffect(() => {
    const GetUserVideos = async () => {
      try {
        if (usermail) {
          const response = await fetch(
            `${backendURL}/videos/getuservideos/${usermail}`
          );
  ...
  useEffect(() => {
    const getPlaylists = async () => {
      try {
        if (user?.email) {
          const response = await fetch(
            `${backendURL}/videos/getplaylistdata/${user?.email}`
          );
    ...
    const getVideoAvailableInPlaylist = async () => {
      try {
        if (id !== undefined && user?.email) {
          const response = await fetch(
            `${backendURL}/videos/getvideodataplaylist/${user?.email}/${id}`
          );
  ...
  useEffect(() => {
    const fetchHeartComments = async () => {
      ...
      try {
        const response = await fetch(`${backendURL}/comments/getheartcomment/${id}`);
  ...
  const uploadComment = async () => {
    try {
      ...
      const response1 = await fetch(
        `${backendURL}/channel/getchannelid/${user?.email}`
      );
      ...
      const response = await fetch(`${backendURL}/comments/comments/${id}`, {
        method: "POST",
        credentials: "include",
  ...
  const likeVideo = async () => {
    try {
      ...
      const response = await fetch(
        `${backendURL}/likes/like/${id}/${user?.email}/${usermail}`,
        {
          method: "POST",
          credentials: "include",
          headers: {
  ...
  const LikeComment = async (commentId) => {
    try {
      if (commentId !== undefined && id !== undefined && user?.email) {
        const response = await fetch(
          `${backendURL}/comments/likecomment/${id}/${commentId}/${user?.email}`,
          {
            method: "POST",
            credentials: "include",
            headers: {
  ...
  const HeartComment = async (commentID) => {
    try {
      if (id !== undefined && channelID !== undefined) {
        const response = await fetch(
          `${backendURL}/comments/heartcomment/${id}/${commentID}`,
          {
            method: "POST",
            credentials: "include",
            headers: {
  ...
  const DeleteComment = async (commentId) => {
    try {
      ...
      const response = await fetch(
        `${backendURL}/comments/deletecomment/${id}/${commentId}/${user?.email}`,
        {
          method: "POST",
          credentials: "include",
          headers: {
  ...
  const DislikeVideo = async () => {
    try {
      const response = await fetch(
        `${backendURL}/likes/dislikevideo/${id}/${user?.email}`,
        {
          method: "POST",
          credentials: "include",
          headers: {
  ...
  const saveVideo = async () => {
    try {
      if (id && user?.email) {
        const response = await fetch(
          `${backendURL}/videos/watchlater/${id}/${user?.email}/${usermail}`,
          {
            method: "POST",
            credentials: "include",
            headers: {
  ...
  const SubscribeChannel = async () => {
    try {
      ...
      const response = await fetch(
        `${backendURL}/channel/subscribe/${channelID}/${user?.email}/${usermail}`,
        {
          method: "POST",
          credentials: "include",
  ...
  const AddPlaylist = async () => {
    try {
      ...
      if (user?.email) {
        ...
        const response = await fetch(
          `${backendURL}/videos/addplaylist/${user?.email}`,
          {
            method: "POST",
            credentials: "include",
            body: JSON.stringify(data),
  ...
  const AddVideoToExistingPlaylist = async (Id) => {
    try {
      if (user?.email && Id !== undefined) {
        ...
        const response = await fetch(
          `${backendURL}/videos/addvideotoplaylist/${user?.email}`,
          {
            method: "POST",
            credentials: "include",
            body: JSON.stringify(data),
  ...
  const RemoveVideo = async (playlistID) => {
    try {
      if (user?.email && id && playlistID) {
        const response = await fetch(
          `${backendURL}/videos/removevideo/${user?.email}/${id}/${playlistID}`,
          {
            method: "POST",
            credentials: "include",
            headers: {
